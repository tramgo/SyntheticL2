...
- Phase162 dense shards scanned: 128 / 384;
- full-year replay complete: 0;
- strategy/profile rows: 24;
- aggregate synthetic-only replay trade count: 2,483,712;
...
Current Phase164 interpretation: the first 128 Phase162 shards show no positive-after-cost strategy/profile rows and no synthetic replay candidates. This is not yet a full-year verdict because 256 Phase162 shards remain. Continue the resumable Phase164 run to 384 / 384 shards, then issue the Phase164 verdict from complete full-year evidence.
