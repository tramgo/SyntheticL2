...
Generated: 2026-08-11T20:36:53.165356+00:00

| metric | value | description |
| --- | --- | --- |
| phase393_available_day_20260803_downloader_complete | 1 | Phase393 complete |
| phase393_target_trade_date | 2026-08-03 | First nearby full partition after shell-only 2026-07-28/29 |
...
| phase393_discovered_file_rows | 50073 | Discovered target file rows |
| phase393_discovered_symbols | 32 | Discovered target symbols |
| phase393_download_manifest_rows | 50073 | Download manifest rows |
| phase393_existing_file_rows | 50042 | Existing/skipped file rows |
| phase393_downloaded_file_rows | 31 | Downloaded file rows |
| phase393_error_file_rows | 0 | Per-file error rows |
| phase393_local_symbols_after | 32 | Local symbols after |
| phase393_local_parquet_files_after | 50073 | Local parquet files after |
| phase393_local_bytes_after | 1751944736 | Local bytes after |
...
| P393_TARGET_AVAILABLE_DISCOVERY | 1 | discovered_rows=50073; local_full=1; error=0 |
