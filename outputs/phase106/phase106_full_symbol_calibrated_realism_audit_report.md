...
Generated UTC: 2026-07-19T22:14:00.881349+00:00
...
| --- | --- | --- |
| phase103_profile_id | P104_HDFCBANK_REAL_ANCHOR_CADENCE_VOL_PRICE_SCALE | Calibrated synthetic profile audited |
...
| phase103_calibration_gap_rows | 50 | Anchor rows outside ratio gates |
| phase103_calibration_gap_fraction | 0.195312 | Fraction of compared symbol/metric anchors outside gates |
...
| tail received tick cadence | p90_gap_ms | 32 | 19 | 0.59375 | 0.173749 | 0.00153602 | 0.692 |
...
| ADANIPORTS | tail received tick cadence | p90_gap_ms | 439477 | 692 | 0.0015746 | 0.2 | 5 | True |
...
| AXISBANK | tail received tick cadence | p90_gap_ms | 305453 | 692 | 0.00226549 | 0.2 | 5 | True |
...
| AXISBANK | L1 imbalance scale | median_abs_l1_imbalance | 0.549598 | 0.022409 | 0.0407734 | 0.25 | 4 | True |
...
| BAJAJ-AUTO | displayed L1 depth scale | median_l1_depth | 61 | 806 | 13.2131 | 0.1 | 10 | True |
| BAJAJ-AUTO | displayed L5 depth scale | median_l5_depth | 366 | 6852.5 | 18.7227 | 0.1 | 10 | True |
| BAJAJ-AUTO | L1 imbalance scale | median_abs_l1_imbalance | 0.578947 | 0 | 0 | 0.25 | 4 | True |
...
| BHARTIARTL | tail received tick cadence | p90_gap_ms | 3949.1 | 692 | 0.17523 | 0.2 | 5 | True |
...
| BHARTIARTL | L1 imbalance scale | median_abs_l1_imbalance | 0.547826 | 0.0797721 | 0.145616 | 0.25 | 4 | True |
...
| BPCL | tail received tick cadence | p90_gap_ms | 448824 | 692 | 0.00154181 | 0.2 | 5 | True |
...
| BPCL | L1 imbalance scale | median_abs_l1_imbalance | 0.653486 | 0.0528053 | 0.0808055 | 0.25 | 4 | True |
...
| BRITANNIA | tail received tick cadence | p90_gap_ms | 450023 | 692 | 0.0015377 | 0.2 | 5 | True |
...
| BRITANNIA | displayed L1 depth scale | median_l1_depth | 35 | 802 | 22.9143 | 0.1 | 10 | True |
| BRITANNIA | displayed L5 depth scale | median_l5_depth | 406.5 | 6816 | 16.7675 | 0.1 | 10 | True |
| BRITANNIA | L1 imbalance scale | median_abs_l1_imbalance | 0.542036 | 0 | 0 | 0.25 | 4 | True |
...
| CIPLA | tail received tick cadence | p90_gap_ms | 447132 | 692 | 0.00154764 | 0.2 | 5 | True |
...
| DRREDDY | tail received tick cadence | p90_gap_ms | 446827 | 692 | 0.0015487 | 0.2 | 5 | True |
...
| GOLDBEES | tail received tick cadence | p90_gap_ms | 439314 | 692 | 0.00157518 | 0.2 | 5 | True |
...
| GOLDBEES | displayed L1 depth scale | median_l1_depth | 11211.5 | 800 | 0.0713553 | 0.1 | 10 | True |
| GOLDBEES | displayed L5 depth scale | median_l5_depth | 95705.5 | 6800 | 0.0710513 | 0.1 | 10 | True |
| GOLDBEES | L1 imbalance scale | median_abs_l1_imbalance | 0.747425 | 0.202279 | 0.270635 | 0.25 | 4 | False |
...
| HINDUNILVR | tail received tick cadence | p90_gap_ms | 442440 | 692 | 0.00156405 | 0.2 | 5 | True |
...
| HINDUNILVR | L1 imbalance scale | median_abs_l1_imbalance | 0.627765 | 0.0730897 | 0.116428 | 0.25 | 4 | True |
...
| INFY | L1 imbalance scale | median_abs_l1_imbalance | 0.758157 | 0.1875 | 0.24731 | 0.25 | 4 | True |
...
| ITBEES | tail received tick cadence | p90_gap_ms | 446258 | 692 | 0.00155067 | 0.2 | 5 | True |
...
| ITBEES | displayed L1 depth scale | median_l1_depth | 134432 | 802 | 0.00596584 | 0.1 | 10 | True |
| ITBEES | displayed L5 depth scale | median_l5_depth | 2.15215e+06 | 6816 | 0.00316706 | 0.1 | 10 | True |
| ITBEES | L1 imbalance scale | median_abs_l1_imbalance | 0.68474 | 0.740331 | 1.08119 | 0.25 | 4 | False |
...
| ITC | tail received tick cadence | p90_gap_ms | 443821 | 692 | 0.00155919 | 0.2 | 5 | True |
...
| ITC | displayed L1 depth scale | median_l1_depth | 5559 | 800 | 0.143911 | 0.1 | 10 | False |
| ITC | displayed L5 depth scale | median_l5_depth | 113657 | 6800 | 0.0598291 | 0.1 | 10 | True |
| ITC | L1 imbalance scale | median_abs_l1_imbalance | 0.589392 | 0.509868 | 0.865075 | 0.25 | 4 | False |
...
| JUNIORBEES | tail received tick cadence | p90_gap_ms | 4750 | 692 | 0.145684 | 0.2 | 5 | True |
...
| KOTAKBANK | tail received tick cadence | p90_gap_ms | 6375 | 692 | 0.108549 | 0.2 | 5 | True |
...
| KOTAKBANK | L1 imbalance scale | median_abs_l1_imbalance | 0.670857 | 0.150568 | 0.224441 | 0.25 | 4 | True |
...
| LT | tail received tick cadence | p90_gap_ms | 3750.7 | 692 | 0.184499 | 0.2 | 5 | True |
...
| LT | displayed L1 depth scale | median_l1_depth | 106 | 806 | 7.60377 | 0.1 | 10 | False |
| LT | displayed L5 depth scale | median_l5_depth | 481 | 6850 | 14.2412 | 0.1 | 10 | True |
| LT | L1 imbalance scale | median_abs_l1_imbalance | 0.549296 | 0.0903955 | 0.164566 | 0.25 | 4 | True |
...
| M&M | displayed L1 depth scale | median_l1_depth | 47 | 806 | 17.1489 | 0.1 | 10 | True |
| M&M | displayed L5 depth scale | median_l5_depth | 447 | 6850 | 15.3244 | 0.1 | 10 | True |
| M&M | L1 imbalance scale | median_abs_l1_imbalance | 0.676548 | 0.18612 | 0.275102 | 0.25 | 4 | False |
...
| MARUTI | displayed L1 depth scale | median_l1_depth | 40 | 806 | 20.15 | 0.1 | 10 | True |
| MARUTI | displayed L5 depth scale | median_l5_depth | 411 | 6851 | 16.6691 | 0.1 | 10 | True |
| MARUTI | L1 imbalance scale | median_abs_l1_imbalance | 0.592949 | 0.132653 | 0.223718 | 0.25 | 4 | True |
...
| NESTLEIND | tail received tick cadence | p90_gap_ms | 443604 | 692 | 0.00155995 | 0.2 | 5 | True |
...
| ONGC | tail received tick cadence | p90_gap_ms | 4017 | 692 | 0.172268 | 0.2 | 5 | True |
...
| ONGC | L1 imbalance scale | median_abs_l1_imbalance | 0.612081 | 0.047619 | 0.0777987 | 0.25 | 4 | True |
...
| SBIN | L1 imbalance scale | median_abs_l1_imbalance | 0.648919 | 0.047619 | 0.0733821 | 0.25 | 4 | True |
...
| SUNPHARMA | tail received tick cadence | p90_gap_ms | 436729 | 692 | 0.00158451 | 0.2 | 5 | True |
...
| TCS | L1 imbalance scale | median_abs_l1_imbalance | 0.682609 | 0.00717703 | 0.0105141 | 0.25 | 4 | True |
...
| TECHM | tail received tick cadence | p90_gap_ms | 3499.7 | 692 | 0.197731 | 0.2 | 5 | True |
...
| TECHM | L1 imbalance scale | median_abs_l1_imbalance | 0.625668 | 0.125 | 0.199786 | 0.25 | 4 | True |
...
| ULTRACEMCO | tail received tick cadence | p90_gap_ms | 450515 | 692 | 0.00153602 | 0.2 | 5 | True |
...
| ULTRACEMCO | displayed L1 depth scale | median_l1_depth | 30 | 808 | 26.9333 | 0.1 | 10 | True |
| ULTRACEMCO | displayed L5 depth scale | median_l5_depth | 309 | 6868 | 22.2265 | 0.1 | 10 | True |
| ULTRACEMCO | L1 imbalance scale | median_abs_l1_imbalance | 0.666667 | 0.427617 | 0.641425 | 0.25 | 4 | False |
...
| WIPRO | L1 imbalance scale | median_abs_l1_imbalance | 0.701962 | 0.0960452 | 0.136824 | 0.25 | 4 | True |
...
| 2 | calibrate_p90_gap_ms | 59.38% of symbol anchors are outside ratio gates; median synthetic/real ratio=0.174. | Adjust generator calibration for tail received tick cadence and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
| 3 | calibrate_median_abs_l1_imbalance | 46.88% of symbol anchors are outside ratio gates; median synthetic/real ratio=0.273. | Adjust generator calibration for L1 imbalance scale and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
| 4 | calibrate_median_l5_depth | 28.12% of symbol anchors are outside ratio gates; median synthetic/real ratio=1.636. | Adjust generator calibration for displayed L5 depth scale and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
| 5 | calibrate_median_l1_depth | 21.88% of symbol anchors are outside ratio gates; median synthetic/real ratio=2.142. | Adjust generator calibration for displayed L1 depth scale and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
| 6 | calibrate_median_spread_bps | 0.00% of symbol anchors are outside ratio gates; median synthetic/real ratio=1.005. | Adjust generator calibration for median spread scale and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
