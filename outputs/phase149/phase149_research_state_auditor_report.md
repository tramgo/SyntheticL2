...
Generated UTC: 2026-07-28T17:09:01.735801+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 182 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 180 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 132 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 53 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 53 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | build_phase190_additional_validation_breadth_or_diagnostic_test_spec_no_execution | Recommended next milestone |
...
| phase | runner_count | output_rows | has_runner | has_outputs | has_acceptance_summary | status | branch | strategy_replay_allowed | pnl_allowed | test_rows_used | test_replay_allowed_next | untouched_test_replay_precommit_allowed | reuse_without_redesign_allowed | breadth_warning | date_count_warning | promotion_allowed | paper_or_live_acceptance_allowed | next_action | runner | output_dir |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
