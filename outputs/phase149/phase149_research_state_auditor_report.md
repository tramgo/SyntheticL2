...
Generated UTC: 2026-07-29T05:42:16.523678+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 220 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 218 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 170 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 308 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 308 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | run_phase228_cost_aware_label_redesign_closure_or_relaxation_precommit_no_fit_no_replay_no_test | Recommended next milestone |
