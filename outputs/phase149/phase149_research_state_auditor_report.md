...
Generated UTC: 2026-07-28T16:48:35.297028+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 178 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 176 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 128 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 34 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 34 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | redesign_cost_aware_receive_flow_family_or_close_current_family_set_before_test_replay | Recommended next milestone |
...
| real_receive_flow_source | validation_interpretation_cost_dominated_redesign_or_close_pending | Phase172 ready_dates=5, additional_dates_needed=0; Phase174 download_ran=1; Phase175 activation_ready=1; Phase176 features_materialized=1; Phase177 quality_audit_ran=1; Phase178 handoff_ready=1; Phase179 precommit_ready=1; Phase180 precommit_ready=1; Phase181 labels_materialized=1; Phase182 label_audit_pass=1; Phase183 replay_readiness=1; Phase184 dry_run_complete=1, test_rows_used=0, promotion_allowed=0; Phase185 interpretation_complete=1, cost_dominates=1, test_replay_allowed_next=0. | redesign_cost_aware_receive_flow_family_or_close_current_family_set_before_test_replay |
...
| phase | runner_count | output_rows | has_runner | has_outputs | has_acceptance_summary | status | branch | strategy_replay_allowed | pnl_allowed | test_rows_used | test_replay_allowed_next | promotion_allowed | paper_or_live_acceptance_allowed | next_action | runner | output_dir |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
