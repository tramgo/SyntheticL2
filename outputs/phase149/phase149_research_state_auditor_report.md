...
Generated UTC: 2026-07-29T04:58:35.941588+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 214 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 212 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 164 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 246 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 246 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | run_phase222_event_only_train_validation_signal_replay_dry_run_no_test | Recommended next milestone |
