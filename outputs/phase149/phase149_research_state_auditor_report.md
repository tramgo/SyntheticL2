...
Generated UTC: 2026-07-28T21:23:05.930249+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 205 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 203 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 155 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 178 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 178 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | run_phase213_material_new_model_source_precommit_no_replay_no_test | Recommended next milestone |
