...
Generated UTC: 2026-07-28T21:05:26.016978+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 202 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 200 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 152 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 155 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 155 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | run_phase210_train_validation_model_fit_dry_run_no_replay_no_test | Recommended next milestone |
