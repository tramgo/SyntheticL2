...
Generated UTC: 2026-07-28T16:44:24.653611+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 177 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 175 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 127 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 29 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 29 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | build_phase185_validation_replay_interpretation_and_kill_switch_audit_no_test | Recommended next milestone |
...
| phase | runner_count | output_rows | has_runner | has_outputs | has_acceptance_summary | status | branch | strategy_replay_allowed | pnl_allowed | test_rows_used | promotion_allowed | paper_or_live_acceptance_allowed | next_action | runner | output_dir |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
