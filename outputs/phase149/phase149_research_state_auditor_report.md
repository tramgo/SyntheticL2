...
Generated UTC: 2026-07-29T05:28:35.509034+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 218 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 216 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 168 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 285 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 285 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | run_phase226_cost_aware_event_label_materialization_dry_run_no_fit_no_replay_no_test | Recommended next milestone |
