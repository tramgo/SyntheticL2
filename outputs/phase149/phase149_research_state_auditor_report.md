...
Generated UTC: 2026-07-28T20:21:45.488119+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 194 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 192 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 144 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 111 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 111 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | run_phase202_passive_feature_redesign_precommit_no_replay | Recommended next milestone |
