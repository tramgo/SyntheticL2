...
Generated UTC: 2026-07-28T20:48:48.606283+00:00
...
| --- | --- | --- |
| phase149_phase_rows | 199 | Phase rows discovered from scripts and outputs |
| phase149_runner_phase_rows | 197 | Phase rows with at least one runner |
| phase149_acceptance_phase_rows | 149 | Phase rows with acceptance summaries |
| phase149_branch_rows | 4 | Current research branches summarized |
| phase149_hard_gate_rows | 137 | Hard global-state gates evaluated |
| phase149_hard_gate_pass_rows | 137 | Hard global-state gates passed |
| phase149_strategy_replay_allowed | 0 | Phase149 never unlocks strategy replay |
| phase149_next_best_action | run_phase207_allowed_feature_matrix_precommit_no_model_no_replay | Recommended next milestone |
