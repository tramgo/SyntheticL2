...
Generated UTC: 2026-07-13T16:10:24.908352+00:00
...
| S01 | G02_economic | Economic gate | stressed profile mean_net_return not positive; Zerodha-derived statutory/brokerage costs are included, but the execution result is still a 5-minute proxy and not acceptance evidence | outputs/phase12/execution_summary.csv; outputs/phase12/cost_schedule.csv |
...
| S01 | G04_risk | Risk gate | No drawdown, tail-loss, position-limit or daily-loss-limit evidence exists in current proxy simulator. | outputs/phase12/execution_summary.csv |
...
| S02 | G02_economic | Economic gate | retail profile mean_net_return not positive; stressed profile mean_net_return not positive; Zerodha-derived statutory/brokerage costs are included, but the execution result is still a 5-minute proxy and not acceptance evidence | outputs/phase12/execution_summary.csv; outputs/phase12/cost_schedule.csv |
...
| S02 | G04_risk | Risk gate | No drawdown, tail-loss, position-limit or daily-loss-limit evidence exists in current proxy simulator. | outputs/phase12/execution_summary.csv |
...
| S03 | G02_economic | Economic gate | stressed profile mean_net_return not positive; Zerodha-derived statutory/brokerage costs are included, but the execution result is still a 5-minute proxy and not acceptance evidence | outputs/phase12/execution_summary.csv; outputs/phase12/cost_schedule.csv |
...
| S03 | G04_risk | Risk gate | No drawdown, tail-loss, position-limit or daily-loss-limit evidence exists in current proxy simulator. | outputs/phase12/execution_summary.csv |
...
| S04 | G04_risk | Risk gate | No drawdown, tail-loss, position-limit or daily-loss-limit evidence exists in current proxy simulator. | outputs/phase12/execution_summary.csv |
...
| S05 | G04_risk | Risk gate | No drawdown, tail-loss, position-limit or daily-loss-limit evidence exists in current proxy simulator. | outputs/phase12/execution_summary.csv |
...
| S06 | G04_risk | Risk gate | No drawdown, tail-loss, position-limit or daily-loss-limit evidence exists in current proxy simulator. | outputs/phase12/execution_summary.csv |
