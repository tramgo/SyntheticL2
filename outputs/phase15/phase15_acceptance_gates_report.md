...
Generated UTC: 2026-07-13T20:24:52.289539+00:00
...
| S01 | G02_economic | Economic gate | stressed profile mean_net_return not positive; statutory/brokerage charges now include Zerodha-sourced order-formula scenarios, but normalized P&L still uses a bps proxy and lacks broker contract-note reconciliation; execution result is still a 5-minute proxy and not acceptance evidence | outputs/phase12/execution_summary.csv; outputs/phase12/cost_schedule.csv |
| S01 | G03_robustness | Robustness gate | Phase 13 has a deterministic proxy smoke ledger, but no acceptance-grade full multi-seed, walk-forward, parameter-smoothness, holdout or real-data rerun evidence. | outputs/phase13/experiment_registry.csv; outputs/phase13/experiment_run_summary.csv |
...
| S02 | G03_robustness | Robustness gate | Phase 13 has a deterministic proxy smoke ledger, but no acceptance-grade full multi-seed, walk-forward, parameter-smoothness, holdout or real-data rerun evidence. | outputs/phase13/experiment_registry.csv; outputs/phase13/experiment_run_summary.csv |
...
| S03 | G03_robustness | Robustness gate | Phase 13 has a deterministic proxy smoke ledger, but no acceptance-grade full multi-seed, walk-forward, parameter-smoothness, holdout or real-data rerun evidence. | outputs/phase13/experiment_registry.csv; outputs/phase13/experiment_run_summary.csv |
...
| S04 | G03_robustness | Robustness gate | Phase 13 has a deterministic proxy smoke ledger, but no acceptance-grade full multi-seed, walk-forward, parameter-smoothness, holdout or real-data rerun evidence. | outputs/phase13/experiment_registry.csv; outputs/phase13/experiment_run_summary.csv |
...
| S05 | G03_robustness | Robustness gate | Phase 13 has a deterministic proxy smoke ledger, but no acceptance-grade full multi-seed, walk-forward, parameter-smoothness, holdout or real-data rerun evidence. | outputs/phase13/experiment_registry.csv; outputs/phase13/experiment_run_summary.csv |
...
| S06 | G03_robustness | Robustness gate | Phase 13 has a deterministic proxy smoke ledger, but no acceptance-grade full multi-seed, walk-forward, parameter-smoothness, holdout or real-data rerun evidence. | outputs/phase13/experiment_registry.csv; outputs/phase13/experiment_run_summary.csv |
