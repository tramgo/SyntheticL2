...
Generated UTC: 2026-07-19T22:02:39.611319+00:00
...
| --- | --- | --- |
| phase103_profile_id | P98_FULL_BOOK_REBALANCE_BASE | Calibrated synthetic profile audited |
...
| phase103_calibration_gap_rows | 3 | Anchor rows outside ratio gates |
| phase103_calibration_gap_fraction | 0.375 | Fraction of compared symbol/metric anchors outside gates |
| phase103_severe_metric_gap_count | 3 | Metrics where more than half of symbols fail calibration gates |
...
| received tick cadence | median_gap_ms | 1 | 1 | 1 | 0.008 | 0.008 | 0.008 |
| tail received tick cadence | p90_gap_ms | 1 | 1 | 1 | 0.195 | 0.195 | 0.195 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HDFCBANK | received tick cadence | median_gap_ms | 500 | 4 | 0.008 | 0.2 | 5 | True |
| HDFCBANK | tail received tick cadence | p90_gap_ms | 1000 | 195 | 0.195 | 0.2 | 5 | True |
...
| 3 | calibrate_median_gap_ms | 100.00% of symbol anchors are outside ratio gates; median synthetic/real ratio=0.008. | Adjust generator calibration for received tick cadence and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
| 4 | calibrate_p90_gap_ms | 100.00% of symbol anchors are outside ratio gates; median synthetic/real ratio=0.195. | Adjust generator calibration for tail received tick cadence and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
| 5 | calibrate_median_abs_l1_imbalance | 0.00% of symbol anchors are outside ratio gates; median synthetic/real ratio=0.857. | Adjust generator calibration for L1 imbalance scale and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
| 6 | calibrate_median_l1_depth | 0.00% of symbol anchors are outside ratio gates; median synthetic/real ratio=0.806. | Adjust generator calibration for displayed L1 depth scale and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
