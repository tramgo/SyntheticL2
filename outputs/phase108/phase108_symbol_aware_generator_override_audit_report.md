...
Generated UTC: 2026-07-19T22:28:11.868419+00:00
...
| --- | --- | --- |
| phase103_profile_id | P108_SYMBOL_AWARE_CADENCE_DEPTH_IMBALANCE | Calibrated synthetic profile audited |
...
| phase103_calibration_gap_rows | 2 | Anchor rows outside ratio gates |
| phase103_calibration_gap_fraction | 0.0078125 | Fraction of compared symbol/metric anchors outside gates |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| L1 imbalance scale | median_abs_l1_imbalance | 32 | 2 | 0.0625 | 0.607369 | 0.0764996 | 1.7549 |
...
| AXISBANK | L1 imbalance scale | median_abs_l1_imbalance | 0.549598 | 0.0900901 | 0.16392 | 0.25 | 4 | True |
...
| BHARTIARTL | L1 imbalance scale | median_abs_l1_imbalance | 0.547826 | 0.319088 | 0.582463 | 0.25 | 4 | False |
...
| BPCL | L1 imbalance scale | median_abs_l1_imbalance | 0.653486 | 0.211221 | 0.323222 | 0.25 | 4 | False |
...
| HINDUNILVR | L1 imbalance scale | median_abs_l1_imbalance | 0.627765 | 0.292473 | 0.465896 | 0.25 | 4 | False |
...
| ONGC | L1 imbalance scale | median_abs_l1_imbalance | 0.612081 | 0.190909 | 0.311902 | 0.25 | 4 | False |
...
| SBIN | L1 imbalance scale | median_abs_l1_imbalance | 0.648919 | 0.190476 | 0.293529 | 0.25 | 4 | False |
...
| TCS | L1 imbalance scale | median_abs_l1_imbalance | 0.682609 | 0.0522193 | 0.0764996 | 0.25 | 4 | True |
...
| 2 | calibrate_median_abs_l1_imbalance | 6.25% of symbol anchors are outside ratio gates; median synthetic/real ratio=0.607. | Adjust generator calibration for L1 imbalance scale and rerun Phase94 comparison. | Gap fraction <= 25% for this metric on the current one-day anchor, then confirm with multi-day real panel. |
