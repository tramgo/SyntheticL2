...
Generated UTC: 2026-07-23T08:17:21.621280+00:00
...
| --- | --- | --- |
| phase117_current_ready_real_anchor_days | 3 | Ready real anchor days proven by latest Phase115/Phase110 evidence |
| phase117_additional_days_needed_for_min | 2 | Additional ready real days needed for minimum replay unlock consideration |
| phase117_additional_days_needed_for_target | 7 | Additional ready real days needed for preferred 10-day target |
| phase117_local_candidate_panel_rows | 17 | Local candidate panel roots/files inventoried |
| phase117_ready_candidate_panel_rows | 15 | Candidate panels with broad enough symbol coverage for import validation |
| phase117_minimum_unlock_acquisition_slots | 2 | Concrete missing day slots required for minimum unlock |
...
| phase117_next_best_action | drop_or_sync_2_more_real_l2_days_then_run_phase115_with_execute_import | Recommended next milestone |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| real_data_sample | real_data_sample | found_parquet | trade_date_symbol | 149477 | 5254282184 | 32 | 1 | 1 | 2026-07-08 | True | validate_with_phase115_execute_import |
...
| scratch_azcopy_selected\raw_l2 | scratch_azcopy_selected\raw_l2 | found_parquet | trade_date_symbol | 49067 | 1726270616 | 32 | 1 | 1 | 2026-07-08 | True | validate_with_phase115_execute_import |
...
| 3 | execute_import_and_refresh_gates | python scripts/run_phase115_real_panel_refresh_orchestrator.py --source-root real_data_sample/l2_multiday_panel --execute-import | True | Copies normalized drop-zone files, verifies integrity, rebuilds Phase96 readiness and Phase110 replay-unlock evidence. |
