...
| --- | --- | --- | --- | --- |
| 1 | download_missing_required_dates | False | powershell -NoProfile -ExecutionPolicy Bypass -File scripts/sync_azure_real_l2_dates_azcopy.ps1 -Dates 2026-07-10,2026-07-14 -ShareSasToken "<read_list_share_sas>" # or use -AccountKey "<storage_account_key>" / AZURE_STORAGE_KEY | At least one required date is not locally ready in scratch or target. |
