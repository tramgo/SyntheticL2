...
DELIVERABLES = [
    ...
    ("WP10", "robustness matrix", "implemented_proxy", "outputs/phase13/experiment_run_summary.csv; outputs/phase13/experiment_profile_robustness_summary.csv", "Pre-registered experiment rows have deterministic proxy smoke and execution-profile robustness ledgers; full robustness validation is not acceptance-grade yet."),
