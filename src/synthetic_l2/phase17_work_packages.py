...
DELIVERABLES = [
    ...
    ("WP8", "risk controls", "implemented_proxy", "outputs/phase12/full_run_risk_summary.csv; outputs/phase12_order_lifecycle/risk_control_summary.csv", "Full-run marketable-proxy risk diagnostics now exist alongside sampled lifecycle/fill-adjusted risk controls; broker/exchange fill-adjusted acceptance evidence remains missing."),
