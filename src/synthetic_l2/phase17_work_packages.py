...
DELIVERABLES = [
    ...
    ("WP2", "trade classification", "partial_proxy", "outputs/phase1/received_tick_deltas_by_symbol", "Received-tick deltas exist; aggressor classification is not acceptance-grade."),
    ...
    ("WP2", "replenishment", "partial_proxy", "outputs/phase11/strategy_feature_availability.csv", "Replenishment is strategy-feature tracked but not fully event reconstructed."),
    ...
    ("WP5", "additions/cancellations/trades", "partial_proxy", "outputs/phase9/tier_a/raw_synthetic_events.parquet", "Tier A events exist, but full event-type realism is not acceptance-grade."),
    ...
    ("WP8", "event-driven engine", "partial_proxy", "outputs/phase12/execution_summary.csv", "Phase 12 is a marketable-order proxy over feature events."),
    ("WP8", "market and limit orders", "partial_proxy", "outputs/phase12/execution_summary.csv", "Marketable orders are modeled; passive limit orders are not."),
    ("WP8", "latency", "implemented_proxy", "outputs/phase12/execution_profiles.csv", "Latency profiles are applied."),
    ("WP8", "partial fills", "missing", "", "Partial fills and queue position are not modeled."),
    ...
    ("WP8", "risk controls", "missing", "", "Drawdown, position, tail-loss and daily-loss controls are not implemented."),
