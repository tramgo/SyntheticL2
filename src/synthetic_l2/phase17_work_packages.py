...
DELIVERABLES = [
    ...
    ("WP8", "fees", "implemented_proxy", "outputs/phase12/cost_schedule.csv; outputs/phase12/charge_component_catalog.csv; outputs/phase12/representative_charge_scenarios.csv", "Zerodha-sourced equity intraday charge formulas are applied to retail/stressed P&L proxy rows with representative order-notional scenarios retained for audit; broker contract-note reconciliation is still missing."),
    ("WP8", "risk controls", "implemented_proxy", "outputs/phase12/full_run_risk_summary.csv; outputs/phase12/full_run_lifecycle_risk_summary.csv; outputs/phase12/full_run_lifecycle_daily_risk_summary.csv; outputs/phase12_order_lifecycle/risk_control_summary.csv", "Full-run marketable-proxy risk diagnostics now include fill-adjusted lifecycle and daily risk summaries across all simulated trades; broker/exchange fill-adjusted acceptance evidence remains missing."),
    ...
    ("WP10", "strategy performance reports", "implemented_proxy", "outputs/phase16/phase16_metrics_reporting_report.md; outputs/phase16/economic_viability_frontier.csv; outputs/phase16/predictive_holdout_stability_summary.csv", "Proxy performance report exists, including economic viability frontier, break-even cost/gross-edge diagnostics and predictive holdout-stability diagnostics."),
