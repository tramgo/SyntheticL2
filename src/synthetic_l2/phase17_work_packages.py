...
DELIVERABLES = [
    ...
    ("WP10", "synthetic realism dashboard", "implemented_proxy", "outputs/dashboard/synthetic_l2_validation_dashboard.html; outputs/phase14/holdout_generator_realism_summary.csv; outputs/phase14/realism_acceptance_gap_ledger.csv", "Static validation dashboard exists over Phase 14-17 quality, holdout-generator realism, realism acceptance-gap, acceptance, metrics and gap evidence."),
    ("WP10", "strategy performance reports", "implemented_proxy", "outputs/phase16/phase16_metrics_reporting_report.md; outputs/phase16/economic_viability_frontier.csv; outputs/phase16/risk_adjusted_economic_frontier.csv; outputs/phase16/broker_reconciliation_readiness.csv; outputs/phase16/economic_reconciliation_strategy_summary.csv; outputs/phase16/economic_acceptance_gap_ledger.csv; outputs/phase16/predictive_holdout_stability_summary.csv; outputs/phase16/predictive_promotion_falsification.csv; outputs/phase16/predictive_acceptance_gap_ledger.csv", "Proxy performance report exists, including economic viability frontier, risk-adjusted economic frontier, broker reconciliation readiness, economic acceptance-gap, break-even cost/gross-edge diagnostics, predictive holdout-stability diagnostics, predictive promotion-falsification and predictive acceptance-gap evidence."),
    ("WP10", "robustness matrix", "implemented_proxy", "outputs/phase13/experiment_run_summary.csv; outputs/phase13/experiment_profile_robustness_summary.csv; outputs/phase13/robustness_dimension_summary.csv; outputs/phase13/robustness_acceptance_gap_ledger.csv", "Pre-registered experiment rows have deterministic proxy smoke, execution-profile robustness, robustness-dimension coverage and acceptance-gap ledgers; full robustness validation is not acceptance-grade yet."),
