...
DELIVERABLES = [
    ...
    ("WP10", "strategy performance reports", "implemented_proxy", "outputs/phase16/phase16_metrics_reporting_report.md; outputs/phase16/economic_viability_frontier.csv; outputs/phase16/risk_adjusted_economic_frontier.csv; outputs/phase16/broker_reconciliation_readiness.csv; outputs/phase16/economic_reconciliation_strategy_summary.csv; outputs/phase16/predictive_holdout_stability_summary.csv; outputs/phase16/predictive_promotion_falsification.csv", "Proxy performance report exists, including economic viability frontier, risk-adjusted economic frontier, broker reconciliation readiness, break-even cost/gross-edge diagnostics, predictive holdout-stability diagnostics and predictive promotion-falsification evidence."),
