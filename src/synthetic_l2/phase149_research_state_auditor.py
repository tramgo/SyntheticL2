...
def phase_status_from_metrics(phase: int) -> dict[str, Any]:
    paths = {
        ...
        338: Path("outputs/phase338/phase338_acceptance_summary.csv"),
        339: Path("outputs/phase339/phase339_acceptance_summary.csv"),
        340: Path("outputs/phase340/phase340_acceptance_summary.csv"),
        341: Path("outputs/phase341/phase341_acceptance_summary.csv"),
        342: Path("outputs/phase342/phase342_acceptance_summary.csv"),
        343: Path("outputs/phase343/phase343_acceptance_summary.csv"),
        344: Path("outputs/phase344/phase344_acceptance_summary.csv"),
        345: Path("outputs/phase345/phase345_acceptance_summary.csv"),
        346: Path("outputs/phase346/phase346_acceptance_summary.csv"),
        347: Path("outputs/phase347/phase347_acceptance_summary.csv"),
        348: Path("outputs/phase348/phase348_acceptance_summary.csv"),
        349: Path("outputs/phase349/phase349_acceptance_summary.csv"),
        350: Path("outputs/phase350/phase350_acceptance_summary.csv"),
    }
    ...
    if phase == 338:
        complete = as_int(metric_value(path, "phase338_cost_stress_holdout_validation_execution_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "cost_stress_holdout_validation_interpretation_open" if complete else "phase338_cost_stress_holdout_validation_execution_gated",
            "cost_stress_holdout_validation_execution_complete": complete,
            "holdout_partition_method": metric_value(path, "phase338_holdout_partition_method", ""),
            "holdout_event_rows": as_int(metric_value(path, "phase338_holdout_event_rows", 0)),
            "scenario_rows": as_int(metric_value(path, "phase338_scenario_rows", 0)),
            "primary_cost200_rows": as_int(metric_value(path, "phase338_primary_cost200_rows", 0)),
            "holdout_acceptance_candidate_rows": as_int(metric_value(path, "phase338_holdout_acceptance_candidate_rows", 0)),
            "best_holdout_candidate": metric_value(path, "phase338_best_holdout_candidate", ""),
            "best_holdout_annualized_return_pct": metric_value(path, "phase338_best_holdout_annualized_return_pct", ""),
            "best_holdout_scheduled_events": as_int(metric_value(path, "phase338_best_holdout_scheduled_events", 0)),
            "best_holdout_positive_symbol_date_cells": as_int(metric_value(path, "phase338_best_holdout_positive_symbol_date_cells", 0)),
            "best_holdout_control_pass": as_int(metric_value(path, "phase338_best_holdout_control_pass", 0)),
            "passive_aware_cost200_above12_rows": as_int(metric_value(path, "phase338_passive_aware_cost200_above12_rows", 0)),
            "passive_aware_cost200_acceptance_rows": as_int(metric_value(path, "phase338_passive_aware_cost200_acceptance_rows", 0)),
            "passive_aware_avg_fill_probability": metric_value(path, "phase338_passive_aware_avg_fill_probability", ""),
            "maker_rebate_assumed": as_int(metric_value(path, "phase338_maker_rebate_assumed", 1)),
            "full_depth_required": as_int(metric_value(path, "phase338_full_depth_required", 0)),
            "levels_2_to_5_required": as_int(metric_value(path, "phase338_levels_2_to_5_required", 0)),
            "l1_only_allowed": as_int(metric_value(path, "phase338_l1_only_allowed", 1)),
            "net_edge_live_mask_allowed": as_int(metric_value(path, "phase338_net_edge_live_mask_allowed", 1)),
            "replay_allowed": as_int(metric_value(path, "phase338_strategy_replay_allowed", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase338_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase338_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase338_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase338_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase338_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase338_next_best_action", ""),
        }
    if phase == 339:
        complete = as_int(metric_value(path, "phase339_cost_stress_holdout_validation_interpretation_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_calendar_acquisition_precommit_open" if complete else "phase339_cost_stress_holdout_validation_interpretation_gated",
            "cost_stress_holdout_validation_interpretation_complete": complete,
            "primary_taker_route_survived_synthetic_holdout": as_int(metric_value(path, "phase339_primary_taker_route_survived_synthetic_holdout", 0)),
            "survivor_rows_preserved": as_int(metric_value(path, "phase339_survivor_rows_preserved", 0)),
            "best_survivor_candidate": metric_value(path, "phase339_best_survivor_candidate", ""),
            "best_survivor_annualized_return_pct": metric_value(path, "phase339_best_survivor_annualized_return_pct", ""),
            "best_survivor_scheduled_events": as_int(metric_value(path, "phase339_best_survivor_scheduled_events", 0)),
            "best_survivor_positive_symbol_date_cells": as_int(metric_value(path, "phase339_best_survivor_positive_symbol_date_cells", 0)),
            "passive_aware_route_status": metric_value(path, "phase339_passive_aware_route_status", ""),
            "passive_aware_cost200_acceptance_rows": as_int(metric_value(path, "phase339_passive_aware_cost200_acceptance_rows", 0)),
            "synthetic_holdout_boundary": metric_value(path, "phase339_synthetic_holdout_boundary", ""),
            "selected_next_route": metric_value(path, "phase339_selected_next_route", ""),
            "contract_rows": as_int(metric_value(path, "phase339_contract_rows", 0)),
            "replay_allowed": as_int(metric_value(path, "phase339_strategy_replay_allowed", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase339_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase339_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase339_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase339_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase339_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase339_next_best_action", ""),
        }
    if phase == 340:
        complete = as_int(metric_value(path, "phase340_official_catalyst_calendar_acquisition_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_real_day_survivor_diagnostic_precommit_open" if complete else "phase340_official_catalyst_calendar_acquisition_gated",
            "official_catalyst_calendar_acquisition_complete": complete,
            "local_real_l2_date_rows": as_int(metric_value(path, "phase340_local_real_l2_date_rows", 0)),
            "nse_announcement_source_ok_dates": as_int(metric_value(path, "phase340_nse_announcement_source_ok_dates", 0)),
            "official_catalyst_rows": as_int(metric_value(path, "phase340_official_catalyst_rows", 0)),
            "official_catalyst_symbols": as_int(metric_value(path, "phase340_official_catalyst_symbols", 0)),
            "same_day_real_l2_catalyst_symbol_dates": as_int(metric_value(path, "phase340_same_day_real_l2_catalyst_symbol_dates", 0)),
            "sbin_official_catalyst_rows": as_int(metric_value(path, "phase340_sbin_official_catalyst_rows", 0)),
            "sbin_official_catalyst_dates": metric_value(path, "phase340_sbin_official_catalyst_dates", ""),
            "replay_allowed": as_int(metric_value(path, "phase340_strategy_replay_allowed", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase340_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase340_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase340_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase340_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase340_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase340_next_best_action", ""),
        }
    if phase == 341:
        complete = as_int(metric_value(path, "phase341_official_catalyst_real_day_survivor_diagnostic_precommit_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_real_day_survivor_diagnostic_execution_open" if complete else "phase341_official_catalyst_real_day_survivor_diagnostic_precommit_gated",
            "official_catalyst_real_day_survivor_diagnostic_precommit_complete": complete,
            "phase340_complete": as_int(metric_value(path, "phase341_phase340_complete", 0)),
            "frozen_survivor_rows": as_int(metric_value(path, "phase341_frozen_survivor_rows", 0)),
            "official_catalyst_rows": as_int(metric_value(path, "phase341_official_catalyst_rows", 0)),
            "no_lookahead_eligible_event_rows": as_int(metric_value(path, "phase341_no_lookahead_eligible_event_rows", 0)),
            "no_lookahead_eligible_symbol_dates": as_int(metric_value(path, "phase341_no_lookahead_eligible_symbol_dates", 0)),
            "sbin_no_lookahead_eligible_rows": as_int(metric_value(path, "phase341_sbin_no_lookahead_eligible_rows", 0)),
            "post_close_rows_shifted_to_next_real_l2_day": as_int(metric_value(path, "phase341_post_close_rows_shifted_to_next_real_l2_day", 0)),
            "work_order_rows": as_int(metric_value(path, "phase341_work_order_rows", 0)),
            "full_depth_schema_pass_rows": as_int(metric_value(path, "phase341_full_depth_schema_pass_rows", 0)),
            "full_depth_schema_rows": as_int(metric_value(path, "phase341_full_depth_schema_rows", 0)),
            "phase342_execution_allowed_next": as_int(metric_value(path, "phase341_phase342_execution_allowed_next", 0)),
            "replay_allowed": as_int(metric_value(path, "phase341_strategy_replay_allowed", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase341_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase341_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase341_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase341_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase341_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase341_next_best_action", ""),
        }
    if phase == 342:
        complete = as_int(metric_value(path, "phase342_official_catalyst_real_day_survivor_diagnostic_execution_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_real_day_diagnostic_interpretation_open" if complete else "phase342_official_catalyst_real_day_survivor_diagnostic_execution_gated",
            "official_catalyst_real_day_survivor_diagnostic_execution_complete": complete,
            "phase341_complete": as_int(metric_value(path, "phase342_phase341_complete", 0)),
            "work_order_rows": as_int(metric_value(path, "phase342_work_order_rows", 0)),
            "filled_trade_rows": as_int(metric_value(path, "phase342_filled_trade_rows", 0)),
            "capacity_selected_trade_rows": as_int(metric_value(path, "phase342_capacity_selected_trade_rows", 0)),
            "capacity_capped_net_pnl_inr": metric_value(path, "phase342_capacity_capped_net_pnl_inr", ""),
            "capacity_capped_annualized_return_pct": metric_value(path, "phase342_capacity_capped_annualized_return_pct", ""),
            "capacity_capped_positive_symbol_date_cells": as_int(metric_value(path, "phase342_capacity_capped_positive_symbol_date_cells", 0)),
            "isolated_all_events_net_pnl_inr": metric_value(path, "phase342_isolated_all_events_net_pnl_inr", ""),
            "isolated_all_events_annualized_return_pct": metric_value(path, "phase342_isolated_all_events_annualized_return_pct", ""),
            "sbin_filled_rows": as_int(metric_value(path, "phase342_sbin_filled_rows", 0)),
            "sbin_capacity_selected_rows": as_int(metric_value(path, "phase342_sbin_capacity_selected_rows", 0)),
            "cost_model_version": metric_value(path, "phase342_cost_model_version", ""),
            "cost_profile": metric_value(path, "phase342_cost_profile", ""),
            "promotion_allowed": as_int(metric_value(path, "phase342_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase342_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase342_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase342_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase342_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase342_next_best_action", ""),
        }
    if phase == 343:
        complete = as_int(metric_value(path, "phase343_official_catalyst_real_day_diagnostic_interpretation_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_native_full_depth_strategy_search_precommit_open" if complete else "phase343_official_catalyst_real_day_diagnostic_interpretation_gated",
            "official_catalyst_real_day_diagnostic_interpretation_complete": complete,
            "phase342_complete": as_int(metric_value(path, "phase343_phase342_complete", 0)),
            "capacity_capped_net_pnl_inr": metric_value(path, "phase343_capacity_capped_net_pnl_inr", ""),
            "capacity_capped_annualized_return_pct": metric_value(path, "phase343_capacity_capped_annualized_return_pct", ""),
            "current_survivor_route_closed": as_int(metric_value(path, "phase343_current_survivor_route_closed", 0)),
            "diagnostic_clue_rows": as_int(metric_value(path, "phase343_diagnostic_clue_rows", 0)),
            "positive_capacity_clue_rows": as_int(metric_value(path, "phase343_positive_capacity_clue_rows", 0)),
            "selected_next_route": metric_value(path, "phase343_selected_next_route", ""),
            "promotion_allowed": as_int(metric_value(path, "phase343_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase343_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase343_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase343_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase343_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase343_next_best_action", ""),
        }
    if phase == 344:
        complete = as_int(metric_value(path, "phase344_official_catalyst_native_full_depth_strategy_search_precommit_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_native_full_depth_strategy_search_execution_open" if complete else "phase344_official_catalyst_native_full_depth_strategy_search_precommit_gated",
            "official_catalyst_native_full_depth_strategy_search_precommit_complete": complete,
            "phase343_complete": as_int(metric_value(path, "phase344_phase343_complete", 0)),
            "failed_survivor_closed": as_int(metric_value(path, "phase344_failed_survivor_closed", 0)),
            "family_rows": as_int(metric_value(path, "phase344_family_rows", 0)),
            "grid_rows": as_int(metric_value(path, "phase344_grid_rows", 0)),
            "negative_control_rows": as_int(metric_value(path, "phase344_negative_control_rows", 0)),
            "material_new_required": as_int(metric_value(path, "phase344_material_new_required", 0)),
            "full_depth_required": as_int(metric_value(path, "phase344_full_depth_required", 0)),
            "levels_2_to_5_required": as_int(metric_value(path, "phase344_levels_2_to_5_required", 0)),
            "l1_only_allowed": as_int(metric_value(path, "phase344_l1_only_allowed", 1)),
            "no_lookahead_required": as_int(metric_value(path, "phase344_no_lookahead_required", 0)),
            "phase345_execution_allowed_next": as_int(metric_value(path, "phase344_phase345_execution_allowed_next", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase344_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase344_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase344_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase344_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase344_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase344_next_best_action", ""),
        }
    if phase == 345:
        complete = as_int(metric_value(path, "phase345_official_catalyst_native_full_depth_strategy_search_execution_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_native_search_interpretation_open" if complete else "phase345_official_catalyst_native_full_depth_strategy_search_execution_gated",
            "official_catalyst_native_full_depth_strategy_search_execution_complete": complete,
            "phase344_complete": as_int(metric_value(path, "phase345_phase344_complete", 0)),
            "grid_rows": as_int(metric_value(path, "phase345_grid_rows", 0)),
            "trade_rows": as_int(metric_value(path, "phase345_trade_rows", 0)),
            "capacity_summary_rows": as_int(metric_value(path, "phase345_capacity_summary_rows", 0)),
            "capacity_above12_rows": as_int(metric_value(path, "phase345_capacity_above12_rows", 0)),
            "acceptance_candidate_rows": as_int(metric_value(path, "phase345_acceptance_candidate_rows", 0)),
            "best_capacity_scenario_id": metric_value(path, "phase345_best_capacity_scenario_id", ""),
            "best_capacity_family_id": metric_value(path, "phase345_best_capacity_family_id", ""),
            "best_capacity_annualized_return_pct": metric_value(path, "phase345_best_capacity_annualized_return_pct", ""),
            "best_capacity_net_pnl_inr": metric_value(path, "phase345_best_capacity_net_pnl_inr", ""),
            "best_capacity_trade_rows": as_int(metric_value(path, "phase345_best_capacity_trade_rows", 0)),
            "best_capacity_control_pass": as_int(metric_value(path, "phase345_best_capacity_control_pass", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase345_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase345_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase345_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase345_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase345_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase345_next_best_action", ""),
        }
    if phase == 346:
        complete = as_int(metric_value(path, "phase346_official_catalyst_native_search_interpretation_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_event_count_expansion_precommit_open" if complete else "phase346_official_catalyst_native_search_interpretation_gated",
            "official_catalyst_native_search_interpretation_complete": complete,
            "phase345_complete": as_int(metric_value(path, "phase346_phase345_complete", 0)),
            "phase345_acceptance_candidate_rows": as_int(metric_value(path, "phase346_phase345_acceptance_candidate_rows", 0)),
            "capacity_above12_rows": as_int(metric_value(path, "phase346_capacity_above12_rows", 0)),
            "control_passing_sparse_candidate_rows": as_int(metric_value(path, "phase346_control_passing_sparse_candidate_rows", 0)),
            "max_candidate_trade_rows": as_int(metric_value(path, "phase346_max_candidate_trade_rows", 0)),
            "event_count_expansion_recommended": as_int(metric_value(path, "phase346_event_count_expansion_recommended", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase346_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase346_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase346_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase346_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase346_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase346_next_best_action", ""),
        }
    if phase == 347:
        complete = as_int(metric_value(path, "phase347_official_catalyst_event_count_expansion_precommit_complete", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_event_count_expansion_execution_open" if complete else "phase347_official_catalyst_event_count_expansion_precommit_gated",
            "official_catalyst_event_count_expansion_precommit_complete": complete,
            "phase346_complete": as_int(metric_value(path, "phase347_phase346_complete", 0)),
            "candidate_grid_rows": as_int(metric_value(path, "phase347_candidate_grid_rows", 0)),
            "official_source_priority_rows": as_int(metric_value(path, "phase347_official_source_priority_rows", 0)),
            "official_timestamp_authority_rows": as_int(metric_value(path, "phase347_official_timestamp_authority_rows", 0)),
            "local_real_l2_dates": as_int(metric_value(path, "phase347_local_real_l2_dates", 0)),
            "official_calendar_rows": as_int(metric_value(path, "phase347_official_calendar_rows", 0)),
            "existing_no_lookahead_work_order_rows": as_int(metric_value(path, "phase347_existing_no_lookahead_work_order_rows", 0)),
            "max_candidate_trade_rows": as_int(metric_value(path, "phase347_max_candidate_trade_rows", 0)),
            "additional_candidate_trade_rows_needed": as_int(metric_value(path, "phase347_additional_candidate_trade_rows_needed", 0)),
            "max_new_dates_per_increment": as_int(metric_value(path, "phase347_max_new_dates_per_increment", 0)),
            "estimated_targeted_date_increments": as_int(metric_value(path, "phase347_estimated_targeted_date_increments", 0)),
            "full_top_five_depth_required": as_int(metric_value(path, "phase347_full_top_five_depth_required", 0)),
            "levels_2_to_5_materiality_required": as_int(metric_value(path, "phase347_levels_2_to_5_materiality_required", 0)),
            "l1_only_allowed": as_int(metric_value(path, "phase347_l1_only_allowed", 0)),
            "fixed_capital_denominator_required": as_int(metric_value(path, "phase347_fixed_capital_denominator_required", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase347_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase347_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase347_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase347_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase347_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase347_next_best_action", ""),
        }
    if phase == 348:
        attempted = as_int(metric_value(path, "phase348_official_catalyst_event_count_expansion_execution_attempted", 0))
        executed = as_int(metric_value(path, "phase348_event_count_expansion_executed", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "official_catalyst_event_count_expansion_interpretation_open" if executed else "official_catalyst_event_count_expansion_storage_access_repair_open",
            "official_catalyst_event_count_expansion_execution_attempted": attempted,
            "phase347_complete": as_int(metric_value(path, "phase348_phase347_complete", 0)),
            "candidate_grid_rows": as_int(metric_value(path, "phase348_candidate_grid_rows", 0)),
            "additional_candidate_trade_rows_needed": as_int(metric_value(path, "phase348_additional_candidate_trade_rows_needed", 0)),
            "local_real_l2_dates": as_int(metric_value(path, "phase348_local_real_l2_dates", 0)),
            "targeted_download_access_available": as_int(metric_value(path, "phase348_targeted_download_access_available", 0)),
            "event_count_expansion_executed": executed,
            "new_real_l2_dates_added": as_int(metric_value(path, "phase348_new_real_l2_dates_added", 0)),
            "new_candidate_trade_rows_added": as_int(metric_value(path, "phase348_new_candidate_trade_rows_added", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase348_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase348_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase348_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase348_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase348_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase348_next_best_action", ""),
        }
    if phase == 349:
        complete = as_int(metric_value(path, "phase349_storage_access_repair_or_sas_targeted_download_precommit_complete", 0))
        sas_present = as_int(metric_value(path, "phase349_sas_env_inputs_present", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "sas_targeted_download_execution_open" if complete and sas_present else "waiting_for_sas_or_azcopy_for_targeted_download",
            "storage_access_repair_or_sas_targeted_download_precommit_complete": complete,
            "phase348_attempted": as_int(metric_value(path, "phase349_phase348_attempted", 0)),
            "sas_env_inputs_present": sas_present,
            "repair_option_rows": as_int(metric_value(path, "phase349_repair_option_rows", 0)),
            "phase350_contract_rows": as_int(metric_value(path, "phase349_phase350_contract_rows", 0)),
            "command_contract_rows": as_int(metric_value(path, "phase349_command_contract_rows", 0)),
            "candidate_grid_rows": as_int(metric_value(path, "phase349_candidate_grid_rows", 0)),
            "secret_material_recorded": as_int(metric_value(path, "phase349_secret_material_recorded", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase349_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase349_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase349_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase349_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase349_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase349_next_best_action", ""),
        }
    if phase == 350:
        attempted = as_int(metric_value(path, "phase350_sas_targeted_one_date_download_attempted", 0))
        downloaded = as_int(metric_value(path, "phase350_downloaded_file_rows", 0))
        return {
            "branch": "synthetic_strategy_discovery",
            "state": "targeted_download_verification_open" if downloaded > 0 else "waiting_for_fresh_blob_sas_or_local_drop_to_rerun_phase350",
            "sas_targeted_one_date_download_attempted": attempted,
            "phase349_complete": as_int(metric_value(path, "phase350_phase349_complete", 0)),
            "sas_env_present": as_int(metric_value(path, "phase350_sas_env_present", 0)),
            "candidate_symbol_rows": as_int(metric_value(path, "phase350_candidate_symbol_rows", 0)),
            "existing_local_dates_before": as_int(metric_value(path, "phase350_existing_local_dates_before", 0)),
            "target_trade_date": metric_value(path, "phase350_target_trade_date", ""),
            "download_manifest_rows": as_int(metric_value(path, "phase350_download_manifest_rows", 0)),
            "downloaded_file_rows": downloaded,
            "new_real_l2_dates_added": as_int(metric_value(path, "phase350_new_real_l2_dates_added", 0)),
            "secret_material_recorded": as_int(metric_value(path, "phase350_secret_material_recorded", 0)),
            "promotion_allowed": as_int(metric_value(path, "phase350_strategy_promotion_allowed", 0)),
            "paper_or_live_acceptance_allowed": as_int(metric_value(path, "phase350_paper_or_live_acceptance_allowed", 0)),
            "profitability_claim_allowed": as_int(metric_value(path, "phase350_deployable_profitability_claim_allowed", 0)),
            "hard_gate_pass_rows": as_int(metric_value(path, "phase350_hard_gate_pass_rows", 0)),
            "hard_gate_rows": as_int(metric_value(path, "phase350_hard_gate_rows", 0)),
            "next_action": metric_value(path, "phase350_next_best_action", ""),
        }
    return {}
...
def build_branch_summary(ledger: pd.DataFrame) -> pd.DataFrame:
    ...
    phase338_complete = as_int(phase338.get("cost_stress_holdout_validation_execution_complete", 0))
    phase339_complete = as_int(phase339.get("cost_stress_holdout_validation_interpretation_complete", 0))
    phase340_complete = as_int(phase340.get("official_catalyst_calendar_acquisition_complete", 0))
    phase341_complete = as_int(phase341.get("official_catalyst_real_day_survivor_diagnostic_precommit_complete", 0))
    phase342_complete = as_int(phase342.get("official_catalyst_real_day_survivor_diagnostic_execution_complete", 0))
    phase343_complete = as_int(phase343.get("official_catalyst_real_day_diagnostic_interpretation_complete", 0))
    phase344_complete = as_int(phase344.get("official_catalyst_native_full_depth_strategy_search_precommit_complete", 0))
    phase345_complete = as_int(phase345.get("official_catalyst_native_full_depth_strategy_search_execution_complete", 0))
    phase346_complete = as_int(phase346.get("official_catalyst_native_search_interpretation_complete", 0))
    phase347_complete = as_int(phase347.get("official_catalyst_event_count_expansion_precommit_complete", 0))
    phase348_attempted = as_int(phase348.get("official_catalyst_event_count_expansion_execution_attempted", 0))
    phase349_complete = as_int(phase349.get("storage_access_repair_or_sas_targeted_download_precommit_complete", 0))
    phase350_attempted = as_int(phase350.get("sas_targeted_one_date_download_attempted", 0))
    if ready_dates >= 5 and additional_dates_needed == 0:
        ...
        if phase338_complete == 1:
            real_receive_status = str(phase338.get("state", "cost_stress_holdout_validation_interpretation_open"))
        if phase339_complete == 1:
            real_receive_status = str(phase339.get("state", "official_catalyst_calendar_acquisition_precommit_open"))
        if phase340_complete == 1:
            real_receive_status = str(phase340.get("state", "official_catalyst_real_day_survivor_diagnostic_precommit_open"))
        if phase341_complete == 1:
            real_receive_status = str(phase341.get("state", "official_catalyst_real_day_survivor_diagnostic_execution_open"))
        if phase342_complete == 1:
            real_receive_status = str(phase342.get("state", "official_catalyst_real_day_diagnostic_interpretation_open"))
        if phase343_complete == 1:
            real_receive_status = str(phase343.get("state", "official_catalyst_native_full_depth_strategy_search_precommit_open"))
        if phase344_complete == 1:
            real_receive_status = str(phase344.get("state", "official_catalyst_native_full_depth_strategy_search_execution_open"))
        if phase345_complete == 1:
            real_receive_status = str(phase345.get("state", "official_catalyst_native_search_interpretation_open"))
        if phase346_complete == 1:
            real_receive_status = str(phase346.get("state", "official_catalyst_event_count_expansion_precommit_open"))
        if phase347_complete == 1:
            real_receive_status = str(phase347.get("state", "official_catalyst_event_count_expansion_execution_open"))
        if phase348_attempted == 1:
            real_receive_status = str(phase348.get("state", "official_catalyst_event_count_expansion_storage_access_repair_open"))
        if phase349_complete == 1:
            real_receive_status = str(phase349.get("state", "waiting_for_sas_or_azcopy_for_targeted_download"))
        if phase350_attempted == 1:
            real_receive_status = str(phase350.get("state", "waiting_for_fresh_blob_sas_or_local_drop_to_rerun_phase350"))
    else:
    ...
    branches = [
        ...
        },
        {
            ...
            "evidence": (
                ...
                f"Phase338 executed holdout validation on {phase338.get('holdout_event_rows', '')} synthetic holdout events with scenarios={phase338.get('scenario_rows', '')}, primary_cost200={phase338.get('primary_cost200_rows', '')}, acceptance_rows={phase338.get('holdout_acceptance_candidate_rows', '')}, best_holdout={phase338.get('best_holdout_candidate', '')}, best_annualized={phase338.get('best_holdout_annualized_return_pct', '')}, best_events={phase338.get('best_holdout_scheduled_events', '')}, positive_symbol_date_cells={phase338.get('best_holdout_positive_symbol_date_cells', '')}, passive_cost200_above12={phase338.get('passive_aware_cost200_above12_rows', '')}, passive_acceptance={phase338.get('passive_aware_cost200_acceptance_rows', '')}, profitability_claim_allowed={phase338.get('profitability_claim_allowed', '')}."
            ),
            "current_next_action": phase350.get("next_action") or phase349.get("next_action") or phase348.get("next_action") or phase347.get("next_action") or phase346.get("next_action") or phase345.get("next_action") or phase344.get("next_action") or phase343.get("next_action") or phase342.get("next_action") or phase341.get("next_action") or phase340.get("next_action") or phase339.get("next_action") or phase338.get("next_action") or phase337.get("next_action") or phase336.get("next_action") or phase335.get("next_action") or phase334.get("next_action") or phase333.get("next_action") or phase332.get("next_action") or phase331.get("next_action") or phase330.get("next_action") or phase329.get("next_action") or phase328.get("next_action") or phase327.get("next_action") or phase326.get("next_action") or phase325.get("next_action") or phase324.get("next_action") or phase323.get("next_action") or phase322.get("next_action") or phase321.get("next_action") or phase320.get("next_action") or phase319.get("next_action") or phase318.get("next_action") or phase317.get("next_action") or phase316.get("next_action") or phase315.get("next_action") or phase314.get("next_action") or phase313.get("next_action") or phase312.get("next_action") or phase311.get("next_action") or phase310.get("next_action") or phase309.get("next_action") or phase308.get("next_action") or phase307.get("next_action") or phase306.get("next_action") or phase305.get("next_action") or phase304.get("next_action") or phase303.get("next_action") or phase302.get("next_action") or phase301.get("next_action") or phase300.get("next_action") or phase299.get("next_action") or phase298.get("next_action") or phase297.get("next_action") or phase296.get("next_action") or phase295.get("next_action") or phase294.get("next_action") or phase293.get("next_action") or phase292.get("next_action") or phase291.get("next_action") or phase290.get("next_action") or phase289.get("next_action") or phase288.get("next_action") or phase287.get("next_action") or phase286.get("next_action") or phase285.get("next_action") or phase284.get("next_action") or phase283.get("next_action") or phase282.get("next_action") or phase281.get("next_action") or phase280.get("next_action") or phase279.get("next_action") or phase278.get("next_action") or phase277.get("next_action") or phase276.get("next_action") or phase275.get("next_action") or phase274.get("next_action") or phase273.get("next_action") or phase272.get("next_action") or phase271.get("next_action") or phase270.get("next_action") or phase269.get("next_action") or phase268.get("next_action") or phase267.get("next_action") or phase266.get("next_action") or phase265.get("next_action") or phase264.get("next_action") or phase263.get("next_action") or phase262.get("next_action") or phase261.get("next_action") or phase260.get("next_action") or phase259.get("next_action") or phase258.get("next_action") or phase257.get("next_action") or phase256.get("next_action") or phase255.get("next_action") or phase254.get("next_action") or phase253.get("next_action") or phase252.get("next_action") or phase251.get("next_action") or phase250.get("next_action") or phase249.get("next_action") or phase248.get("next_action") or phase247.get("next_action") or phase246.get("next_action") or phase245.get("next_action") or phase244.get("next_action") or phase243.get("next_action") or phase242.get("next_action") or phase241.get("next_action") or phase240.get("next_action") or phase239.get("next_action") or phase238.get("next_action") or phase237.get("next_action") or phase235.get("next_action") or phase234.get("next_action") or phase233.get("next_action") or phase232.get("next_action") or phase231.get("next_action") or phase230.get("next_action") or phase229.get("next_action") or "run_phase229_or_phase230_strategy_discovery",
        },
        {
            "branch": "dense_synthetic_replay",
            "status": "not_promoted",
